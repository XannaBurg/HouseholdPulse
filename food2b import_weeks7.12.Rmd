---
title: "Household Pulse Food 2B"
output: html_document
---

#THIS CODE WORKS FOR WEEKS 7-12
#IMPORT HOUSEHOLD PULSE DATA FROM TABLE FOOD 2B
#STORE DATA IN SQL DATABASE: food2b

## This code simply imports the data from Food Table 2b, and calculates the food insufficient numerator, denominator, and a nonresponse percent.
...
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/food2b_week",week,".xlsx"), 
                temp.file, mode = "wb")

food2b_data <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 4) %>%
...
temp.file <- paste(tempfile(),".xlsx",sep = "")
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/food2b_se_week",week,".xlsx"), 
                temp.file, mode = "wb")

food2b_data_se <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 4) %>%
    set_names(food2b_colnames) %>%

...
categorynames <- c('total',
                   'foodsufficiency_beforeMarch2020','foodsufficiency_beforeMarch2020',
                   'foodsufficiency_beforeMarch2020','foodsufficiency_beforeMarch2020',
                   'foodsufficiency_beforeMarch2020',
                   ...
                   'childrennoteating','childrennoteating','childrennoteating',
                   'childrennoteating',
                   'foodnextfourweeks','foodnextfourweeks','foodnextfourweeks',
                   'foodnextfourweeks','foodnextfourweeks',
...
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/food5_week",week,".xlsx"), 
                temp.file, mode = "wb")

food5_data <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 4) %>%
...
temp.file <- paste(tempfile(),".xlsx",sep = "")
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/food5_se_week",week,".xlsx"), 
                temp.file, mode = "wb")

food5_data_se <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 4) %>%
    set_names(food5_colnames) %>%

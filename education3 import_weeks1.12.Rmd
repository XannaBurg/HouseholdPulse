...
#THIS CODE WORKS FOR WEEKS 1-12
...
categorynames <- c('total','age','age','age','age','age',
                          ...
                          'children','children',
                          'computer_source','computer_source',
                          'computer_source','computer_source',
                          ...
                          'currentemploy',
                          'food_sufficiency','food_sufficiency','food_sufficiency',
                          'food_sufficiency','food_sufficiency',
...
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/educ3_week",week,".xlsx"), 
                temp.file, mode = "wb")

education3_data <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 4) %>%
...
temp.file <- paste(tempfile(),".xlsx",sep = "")
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/educ3_se_week",week,".xlsx"), 
                temp.file, mode = "wb")

education3_data_se <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 4) %>%
    set_names(education3_colnames) %>%

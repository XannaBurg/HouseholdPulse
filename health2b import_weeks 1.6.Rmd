...
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/health2b_week",week,".xlsx"), 
                temp.file, mode = "wb")

health2b_data <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 5) %>%
...
temp.file <- paste(tempfile(),".xlsx",sep = "")
download.file(paste0
                ("https://www2.census.gov/programs-surveys/demo/tables/hhp/2020/wk",week,"/health2b_se_week",week,".xlsx"), 
                temp.file, mode = "wb")

health2b_data_se <- read_excel(temp.file, sheet=paste0(state_abbr),skip = 5) %>%
    set_names(health2b_colnames) %>%
